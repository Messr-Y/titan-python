...
CLASSES = ['background', 'coat', 'person']
root = 'C:/Users/HP/pythonProject/VOC2023/'
...
class VOCDataset(torch.utils.data.Dataset):
    def __init__(self, img_ids, transforms=None):
        global num_person, num_coat, flag
...
print("num_coat={}".format(num_coat))
